...
MAINTAINER Josiah Goodson <jgoodson@cloudera.com>
...
\
# Download HBase
# Version 2.0.0 can no longer be verified because Michael Stack removed his key used to sign this release from the
